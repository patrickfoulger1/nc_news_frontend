...
function ArticleSortMenu({ visible, sorts }) {
  ...
  return (
    <>
      <section
        className={`${visible ? "" : "hidden"} grid grid-cols-3 grid-rows-2 gap-0 absolute flex bottom-25 left-1/2 md:left-3/4 transform -translate-x-1/2 fixed absolute w-1/4 min-w-100 h-50  z-50`}
      >
        {sortLinks}
      </section>
    </>
