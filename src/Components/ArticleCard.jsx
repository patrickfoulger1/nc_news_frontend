    ...
    >
      <figure className="w-full h-full hover:border-red-500 hover:border-3">
        <img
          ...
          alt={title}
        />
        <figcaption className="absolute bottom-27 left-2/4 flex w-[calc(100%-4rem)] -translate-x-2/4 justify-between rounded-xl border border-white bg-white/90 py-4 px-6 shadow-lg shadow-black/5 ">
          <div>
